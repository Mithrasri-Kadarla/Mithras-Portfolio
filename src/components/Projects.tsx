...
export default function Projects() {
  ...
  return (
    ...
    >
      <h2 className="text-5xl font-extrabold text-center text-[#4682A9] mb-16">
        🚀 Featured Projects
      </h2>
      ...
      <div className="relative max-w-7xl mx-auto flex items-center">
        ...
        {/* 3 Project Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mx-auto w-full px-12">
          {getVisibleCards().map((project, index) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                <h3 className="absolute bottom-4 left-5 text-2xl font-semibold text-white drop-shadow-lg">
                  {project.title}
                </h3>
              </div>
              ...
              {/* Content */}
              <div className="p-6">
                <p className="text-[#2c3e50] text-sm font-medium leading-relaxed mb-5">
                  {project.description}
                </p>
